...
import { generateInstagramIdea } from '../services/openai';
...
export default function AppPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const content = await generateInstagramIdea(blogUrl, selectedStage, selectedPostType);
          ...
          <div className="bg-gradient-to-r from-primary/20 to-secondary/20 p-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600">Convert Your Blog Articles into Creative Instagram Post Ideas</p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="p-8 space-y-8">
            ...
            >
              ...
              <motion.button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-6 py-4 text-base font-medium rounded-xl text-black bg-gradient-to-r from-primary via-secondary to-accent hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? 'Generating...' : 'Generate Creative Ideas'}
